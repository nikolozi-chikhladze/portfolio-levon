export const ABOUT_DESCRIPTION_DATA = [
  ...
  },
  {
    ...
    text: {
      ...
      list: {
        title: "",
        items: [
          "Developing designs that are user-friendly, easy to navigate, and visually appealing.",
          "Conducting user research to gain insights into the needs and expectations of our users.",
          "Collaborating with cross-functional teams, including developers, product managers, and customer support teams, to ensure that the design meets the needs of the business and our users.",
          "Creating wireframes and prototypes to test and validate design concepts.",
          "Conducting user testing and A/B testing to gather feedback and optimize the design.",
          "Ensuring that the design is accessible to users with disabilities and complies with web accessibility guidelines.",
          "Continuously iterating and improving the design based on user feedback and data-driven insights.",
        ],
      },

...
const JOB_KEY = "novartis"

const NovartisPage = ({ location }) => {
  ...
  return (
    <div style={{ paddingRight: 32, backgroundColor: "#242424" }}>
      ...
      <WorkNavigation previous={"/fin-fly"} next={"/hca-healthcare"} />
      <Footer />
    </div>
  )
}

export const Head = () => <Seo title="Novartis" />

export default NovartisPage

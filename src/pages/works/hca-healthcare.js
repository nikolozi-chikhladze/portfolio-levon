...
const JOB_KEY = "hca-healthcare"

const HcaHealthCarePage = ({ location }) => {
  ...
  return (
    <div style={{ paddingRight: 32, backgroundColor: "#242424" }}>
      ...
      <WorkNavigation previous={"/novartis"} next={"/spvrkd"} />
      <Footer />
    </div>
  )
}

export const Head = () => <Seo title="HCA Healthcare" />

export default HcaHealthCarePage

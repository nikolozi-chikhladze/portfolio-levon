...
const JOB_KEY = "fin-fly"

const FinFlyPage = ({ location }) => {
  ...
  return (
    <div style={{ paddingRight: 32, backgroundColor: "#242424" }}>
      ...
      <WorkNavigation previous={"/keeps-me"} next={"/novartis"} />
      <Footer />
    </div>
  )
}

export const Head = () => <Seo title="FinFly" />

export default FinFlyPage

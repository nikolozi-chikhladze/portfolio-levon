...
const JOB_KEY = "spvrkd"

const SpvrkdPage = ({ location }) => {
  ...
  return (
    <div style={{ paddingRight: 32, backgroundColor: "#242424" }}>
      ...
      <WorkNavigation previous={"/hca-healthcare"} next={"/inecobank"} />
      <Footer />
    </div>
  )
}

export const Head = () => <Seo title="Spvrkd" />

export default SpvrkdPage
